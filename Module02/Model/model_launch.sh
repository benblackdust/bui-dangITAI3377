...
then
    ...
    docker build . -t module02-model --no-cache
fi
docker run -it --rm --gpus=all -p 8888:8888 -p 5000:5000 -v /home/adam/GitRepos/ITAI-3377/Module02/Model/notebooks:/root/notebooks module02-model